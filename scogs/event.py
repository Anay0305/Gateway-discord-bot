...
from botinfo import *
from scogs.selfroles import DropdownSelfRoleView, ButtonSelfRoleView
import botinfo
import database
import emojis
...
class event(commands.Cog):
    ...
    async def on_ready(self):
        bot = self.bot
        await bot.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.listening, name="Snaps ♡"))
        try:
            await loadselfroles(bot)
        except:
            pass
