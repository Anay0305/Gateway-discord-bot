...
class roledropdownmenu(discord.ui.Select):
    def __init__(self, ctx: commands.Context, opt: list, user: Union[discord.Member, discord.Role, discord.TextChannel]):
        ...
        if len(opt) == 0:
            super().__init__(placeholder="Select the roles to bypass",
                min_values=1,
                max_values=1,
                options=[discord.SelectOption(label=f"LnL", value="LnL")],
                disabled=True
            )
        else:
            super().__init__(placeholder="Select the roles to bypass",
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        for i in self.values:
            ...
            ls.append(c.mention)
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass `{', '.join(ls)}` roles", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
...
class rolemenuview(discord.ui.View):
    ...
    async def okkkkkk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass all ignored roles", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class channeldropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        for i in self.values:
            ...
            ls.append(c.mention)
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass `{', '.join(ls)}` channels", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class channelmenuview(discord.ui.View):
    ...
    async def okkkkk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass all ignored channels", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class cmddropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass `{', '.join(ls)}` commands", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class cmdmenuview(discord.ui.View):
    ...
    async def both(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass all ignored commands", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class moduledropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        db.close()
        ls = [str(i) for i in self.values]
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass `{', '.join(ls)}` modules", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class modulemenuview(discord.ui.View):
    ...
    async def okkkk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass all ignored modules", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class mainview(discord.ui.View):
    ...
    async def _cmdsss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which commands should be allowed for {self.user.mention} to bypass?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
    ...
    async def _modulesss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which modules should be allowed for {self.user.mention} to bypass?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def _channelsss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which channels should be allowed for {self.user.mention} to bypass?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def _rolesss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which roles should be allowed for {self.user.mention} to bypass?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def all(self, interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully allowed {self.user.mention} to bypass all types of ignorence in the server", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rroledropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        for i in self.values:
            c = discord.utils.get(self.ctx.guild.roles, id=i)
            ls.append(c.mention)
        em = discord.Embed(description=f"Successfully removed bypass of `{', '.join(ls)}` roles in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rrolemenuview(discord.ui.View):
    ...
    async def okkkkkk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully removed bypass of all roles in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rchanneldropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        for i in self.values:
            c = discord.utils.get(self.ctx.guild.channels, id=i)
            ls.append(c.mention)
        em = discord.Embed(description=f"Successfully removed bypass of `{', '.join(ls)}` channels in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rchannelmenuview(discord.ui.View):
    ...
    async def okkkkk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully removed bypass of all channels in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rcmddropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        db.close()
        ls = [str(i) for i in self.values]
        em = discord.Embed(description=f"Successfully removed bypass of `{', '.join(ls)}` commands in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rcmdmenuview(discord.ui.View):
    ...
    async def both(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully removed bypass of all commands in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rmoduledropdownmenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        db.close()
        ls = [str(i) for i in self.values]
        em = discord.Embed(description=f"Successfully removed bypass of `{', '.join(ls)}` modules in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rmodulemenuview(discord.ui.View):
    ...
    async def okkkasddskk(self, interaction: discord.Interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully removed bypass of all modules in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class rmainview(discord.ui.View):
    ...
    async def _cmdsdffsss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which commands should be removed from being bypassed by {self.user.mention}?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def _moduldfdsfesss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which modules should be removed from being bypassed by {self.user.mention}?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def _channedfdsflsss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which channel should be removed from being bypassed by {self.user.mention}?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def _rolasfasfesss(self, interaction, button):
        ...
        em = discord.Embed(description=f"Which roles should be removed from being bypassed by {self.user.mention}?", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=v)
    ...
    async def alfasfll(self, interaction, button):
        ...
        cursor.close()
        db.close()
        em = discord.Embed(description=f"Successfully removed bypass of all types of ignorence in the server from {self.user.mention}", color=botinfo.root_color).set_footer(text=self.ctx.guild.me.name, icon_url=self.ctx.guild.me.avatar.url)
        await interaction.edit_original_response(embed=em, view=None)
...
class ignore(commands.Cog):
            ...
            if user.id in lss:
                ...
                if 'role' in lss[user.id]:
                    if lss[user.id]['role'] == "all":
                        c+=1
        if c == 4:
            return await ctx.reply(embed=discord.Embed(description=f"{user.mention} is already bypassed for all types of ignorance in the server", color=botinfo.wrong_color))
        if ig_db is not None:
            xd = literal_eval(ig_db['user'])
            if user.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{user.mention} is being ignored by the bot. In order to let him bypass the ignore first removed him from being ignored by typing `{ctx.prefix}ignore user remove {user.mention}`", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be given to {user.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
        v = mainview(ctx, user)
    ...
    async def __remove(self, ctx: commands.Context, *, user: discord.Member):
        ...
        if by_db is not None:
            ...
            if user.id in lss:
                ...
                c = 4
        if c == 4:
            return await ctx.reply(embed=discord.Embed(description=f"{user.mention} is not bypassed for any type of ignorance in the server", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be remove from {user.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
            ...
            if role.id in lss:
                ...
                if 'role' in lss[role.id]:
                    if lss[role.id]['role'] == "all":
                        c+=1
        if c == 4:
            return await ctx.reply(embed=discord.Embed(description=f"{role.mention} is already bypassed for all types of ignorance in the server", color=botinfo.wrong_color))
        if ig_db is not None:
            xd = literal_eval(ig_db['role'])
            if role.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{role.mention} is being ignored by the bot. In order to let him bypass the ignore first removed him from being ignored by typing `{ctx.prefix}ignore role remove {role.mention}`", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be given to {role.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
        v = mainview(ctx, role)
        await ctx.reply(embed=em, view=v)
    ...
    async def __removee(self, ctx: commands.Context, *, role: discord.Role):
        ...
        if by_db is not None:
            ...
            if role.id in lss:
                ...
                c = 4
        if c == 4:
            return await ctx.reply(embed=discord.Embed(description=f"{role.mention} is not bypassed for any type of ignorance in the server", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be remove from {role.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
            ...
            if channel.id in lss:
                ...
                if 'role' in lss[channel.id]:
                    if lss[channel.id]['role'] == "all":
                        c+=1
        if c == 3:
            return await ctx.reply(embed=discord.Embed(description=f"{channel.mention} is already bypassed for all types of ignorance in the server", color=botinfo.wrong_color))
        if ig_db is not None:
            xd = literal_eval(ig_db['channel'])
            if channel.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{channel.mention} is being ignored by the bot. In order to let him bypass the ignore first removed him from being ignored by typing `{ctx.prefix}ignore channel remove {channel.mention}`", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be given to {channel.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
    ...
    async def __removeee(self, ctx: commands.Context, *, channel: discord.TextChannel):
        ...
        if by_db is not None:
            ...
            if channel.id in lss:
                ...
                c = 3
        if c == 3:
            return await ctx.reply(embed=discord.Embed(description=f"{channel.mention} is not bypassed for any type of ignorance in the server", color=botinfo.wrong_color))
        em = discord.Embed(description=f"Which type of bypass should be remove from {channel.mention}", color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
    ...
    async def _add(self, ctx: commands.Context, *, user: discord.Member):
        ...
        if ig_db is None:
            ...
            xd = literal_eval(ig_db['user'])
            if user.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{user.mention} is already being ignored by the bot", color=botinfo.wrong_color))
            else:
                xd.append(user.id)
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {user.mention} will be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _remove(self, ctx: commands.Context, *, user: discord.Member):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"{user.mention} is already not being ignored by the bot", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['user'])
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {user.mention} will not be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _show(self, ctx: commands.Context):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"No users are being ignored in the server", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['user'])
            if len(xd) == 0:
                return await ctx.reply(embed=discord.Embed(description=f"No users are being ignored in the server", color=botinfo.wrong_color))
        ...
        for i in xd:
            ...
            if u is not None:
                ls.append(u.mention)
        em = discord.Embed(title=f"Ignored users - {len(xd)}", description="\n".join(ls), color=botinfo.root_color).set_footer(text=self.bot.user.name, icon_url=self.bot.user.avatar.url)
    ...
    async def _addd(self, ctx: commands.Context, *, channel: discord.TextChannel):
        ...
        if ig_db is None:
            ...
            xd = literal_eval(ig_db['channel'])
            if channel.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{channel.mention} is already being ignored by the bot", color=botinfo.wrong_color))
            else:
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {channel.mention} will be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _removee(self, ctx: commands.Context, *, channel: discord.TextChannel):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"{channel.mention} is already not being ignored by the bot", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['channel'])
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {channel.mention} will not be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _showw(self, ctx: commands.Context):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"No channels are being ignored in the server", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['channel'])
            if len(xd) == 0:
                return await ctx.reply(embed=discord.Embed(description=f"No channels are being ignored in the server", color=botinfo.wrong_color))
    ...
    async def _adddd(self, ctx: commands.Context, *, role: discord.Role):
        ...
        if ig_db is None:
            ...
            xd = literal_eval(ig_db['role'])
            if role.id in xd:
                return await ctx.reply(embed=discord.Embed(description=f"{role.mention} is already being ignored by the bot", color=botinfo.wrong_color))
            else:
                xd.append(role.id)
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {role.mention} will be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _removeee(self, ctx: commands.Context, *, role: discord.Role):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"{role.mention} is already not being ignored by the bot", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['role'])
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards {role.mention} will not be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _showww(self, ctx: commands.Context):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"No roles are being ignored in the server", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['role'])
            if len(xd) == 0:
                return await ctx.reply(embed=discord.Embed(description=f"No roles are being ignored in the server", color=botinfo.wrong_color))
    ...
    async def _addddd(self, ctx: commands.Context, *, command: str):
        ...
        if cmd is None:
            return await ctx.reply(embed=discord.Embed(description=f"No command found named `{command}`", color=botinfo.wrong_color), mention_author=False)
        if str(cmd.cog_name.lower()) == "ignore":
            return await ctx.reply(embed=discord.Embed(description=f"Ignore commands cant be ignored", color=botinfo.wrong_color), mention_author=False)
        if ig_db is None:
            ...
            if cmd.qualified_name in xd:
                return await ctx.reply(embed=discord.Embed(description=f"`{cmd.qualified_name}` command is already being ignored by the bot", color=botinfo.wrong_color))
            else:
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards `{cmd.qualified_name}` command will be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _removeeee(self, ctx: commands.Context, *, command: str):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"`{cmd.qualified_name}` command is already not being ignored by the bot", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['cmd'])
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards `{cmd.qualified_name}` command will not be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _showwww(self, ctx: commands.Context):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"No commands are being ignored in the server", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['cmd'])
            if len(xd) == 0:
                return await ctx.reply(embed=discord.Embed(description=f"No commands are being ignored in the server", color=botinfo.wrong_color))
    ...
    async def _adddddd(self, ctx: commands.Context, *, module: str):
        ...
        if module.lower() == "ignore":
            return await ctx.reply(embed=discord.Embed(description=f"Ignore module cant be ignored", color=botinfo.wrong_color), mention_author=False)
        dc = {
            "mod": "moderation",
            "mods": "moderation",
            "security": "antinuke",
        ...
        if module is None:
            return await ctx.reply(embed=discord.Embed(description=f"No module found named `{m_name}`", color=botinfo.wrong_color), mention_author=False)
        if ig_db is None:
            ...
            if module.qualified_name in xd:
                return await ctx.reply(embed=discord.Embed(description=f"`{module.qualified_name}` module is already being ignored by the bot", color=botinfo.wrong_color))
            else:
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards `{module.qualified_name}` command will be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _removeeeee(self, ctx: commands.Context, *, module: str):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"`{module.qualified_name}` module is already not being ignored by the bot", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['module'])
        ...
        cursor.close()
        db.close()
        return await ctx.reply(embed=discord.Embed(description=f"Now onwards `{module.qualified_name}` module will not be ignored by the bot.", color=botinfo.root_color))
    ...
    async def _showwwww(self, ctx: commands.Context):
        ...
        with sqlite3.connect('database.sqlite3') as db:
            ...
            ig_db = cursor.fetchone()
        if ig_db is None:
            return await ctx.reply(embed=discord.Embed(description=f"No module are being ignored in the server", color=botinfo.wrong_color))
        else:
            xd = literal_eval(ig_db['module'])
            if len(xd) == 0:
                return await ctx.reply(embed=discord.Embed(description=f"No module are being ignored in the server", color=botinfo.wrong_color))
